...
Every failure inside jetson raises :class:`CliError`. The
top-level ``main()`` catches it, formats via :mod:`jetson.cli._output`,
...
# Exit-code policy. Documented in ``jetson learn`` output.
# 0      = success
