...
--------------------------
Every handler raises :class:`jetson.cli._errors.CliError` on
failure; ``main()`` catches it via :func:`_dispatch` and routes through
:mod:`jetson.cli._output`. Unknown exceptions are wrapped into a
...
from jetson.cli._errors import EXIT_USER_ERROR, CliError
from jetson.cli._output import emit_error

_ISSUES_URL = "https://github.com/agentculture/jetson/issues"
...
def _build_parser() -> argparse.ArgumentParser:
    ...
    from jetson.cli._commands import learn as _learn_cmd
    from jetson.cli._commands import overview as _overview_cmd
    from jetson.cli._commands import whoami as _whoami_cmd
